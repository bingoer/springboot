...
public class HuobiproCrossJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		logger.info("线程 "+ HUOBIPRO +" 2h指标数据保存:"+Thread.currentThread().getName()+"运行开始.....");
		crossServer.saveCross(HUOBIPRO, CommonInterval.TWO_HOURLY);
		logger.info("线程 "+ HUOBIPRO +" 2h指标数据保存:"+Thread.currentThread().getName()+"运行结束.....");
	}
