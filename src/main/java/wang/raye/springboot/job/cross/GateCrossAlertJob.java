...
public class GateCrossAlertJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		logger.info("线程 "+ GATE +" 指标交叉提醒:"+Thread.currentThread().getName()+"运行开始.....");
		crossServer.crossMonitor(GATE, CommonInterval.TWO_HOURLY);
		logger.info("线程 "+ GATE +" 指标交叉提醒:"+Thread.currentThread().getName()+"运行结束.....");
	}
