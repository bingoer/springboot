...
public class BinanceDojiJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		logger.info("线程 "+ BINANCE +" 1h指标数据保存:"+Thread.currentThread().getName()+"运行开始.....");
		crossServer.saveCross(BINANCE, CommonInterval.HOURLY);
		logger.info("线程 "+ BINANCE +" 1h指标数据保存:"+Thread.currentThread().getName()+"运行结束.....");
	}
