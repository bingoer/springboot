...
public class HadaxChange30mJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		logger.info("线程 "+ HADAX +" 涨跌幅提醒:"+Thread.currentThread().getName()+"运行开始.....");
		changeServer.netChange(HADAX, CommonInterval.HALF_HOURLY);
		logger.info("线程 "+ HADAX +" 涨跌幅提醒:"+Thread.currentThread().getName()+"运行结束.....");
	}
