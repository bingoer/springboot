...
public class BittrexChange30mJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		logger.info("线程 "+ BITTREX +" 涨跌幅提醒:"+Thread.currentThread().getName()+"运行开始.....");
		changeServer.netChange(BITTREX, CommonInterval.HALF_HOURLY);
		logger.info("线程 "+ BITTREX +" 涨跌幅提醒:"+Thread.currentThread().getName()+"运行结束.....");
	}
