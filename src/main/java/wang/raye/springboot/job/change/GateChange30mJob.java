...
public class GateChange30mJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		logger.info("线程 "+ GATE +" 涨跌幅提醒:"+Thread.currentThread().getName()+"运行开始.....");
		changeServer.netChange(GATE, CommonInterval.HALF_HOURLY);
		logger.info("线程 "+ GATE +" 涨跌幅提醒:"+Thread.currentThread().getName()+"运行结束.....");
	}
