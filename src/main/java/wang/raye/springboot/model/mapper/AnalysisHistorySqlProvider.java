...
import wang.raye.springboot.model.AnalysisHistoryCriteria.Criteria;
import wang.raye.springboot.model.AnalysisHistoryCriteria.Criterion;
import wang.raye.springboot.model.AnalysisHistoryCriteria;

public class AnalysisHistorySqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(AnalysisHistoryCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("analysis_history");
     ...
     * @mbg.generated
     */
    public String deleteByExample(AnalysisHistoryCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("analysis_history");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(AnalysisHistory record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("analysis_history");
     ...
     * @mbg.generated
     */
    public String selectByExample(AnalysisHistoryCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        AnalysisHistory record = (AnalysisHistory) parameter.get("record");
        AnalysisHistoryCriteria example = (AnalysisHistoryCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("analysis_history");
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(AnalysisHistory record) {
        SQL sql = new SQL();
        sql.UPDATE("analysis_history");
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, AnalysisHistoryCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
