...
import wang.raye.springboot.model.TradePointQuotaCriteria.Criteria;
import wang.raye.springboot.model.TradePointQuotaCriteria.Criterion;
import wang.raye.springboot.model.TradePointQuotaCriteria;

public class TradePointQuotaSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(TradePointQuotaCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("trade_point_quota");
     ...
     * @mbg.generated
     */
    public String deleteByExample(TradePointQuotaCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("trade_point_quota");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(TradePointQuota record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("trade_point_quota");
        ...
        if (record.getQuotaType() != null) {
            sql.VALUES("quota_type", "#{quotaType,jdbcType=VARCHAR}");
        }
        ...
        if (record.getQuota5() != null) {
            sql.VALUES("quota5", "#{quota5,jdbcType=DOUBLE}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExample(TradePointQuotaCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TradePointQuota record = (TradePointQuota) parameter.get("record");
        TradePointQuotaCriteria example = (TradePointQuotaCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("trade_point_quota");
        ...
        if (record.getQuotaType() != null) {
            sql.SET("quota_type = #{record.quotaType,jdbcType=VARCHAR}");
        }
        ...
        if (record.getQuota5() != null) {
            sql.SET("quota5 = #{record.quota5,jdbcType=DOUBLE}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(TradePointQuota record) {
        SQL sql = new SQL();
        sql.UPDATE("trade_point_quota");
        ...
        if (record.getQuotaType() != null) {
            sql.SET("quota_type = #{quotaType,jdbcType=VARCHAR}");
        }
        ...
        if (record.getQuota5() != null) {
            sql.SET("quota5 = #{quota5,jdbcType=DOUBLE}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, TradePointQuotaCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
